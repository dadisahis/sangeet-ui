          ...
          <div className="playlist_right_container">
            <div className="right_top">
              ...
              <div className="playlist_title_container">
                <h3>{playlistObj && playlistObj.type.split("_").join(" ")}</h3>
                <h1>{playlistObj && playlistObj.name}</h1>
                <p>{playlistObj && playlistObj.tracks.length} songs</p>
              </div>
            </div>
            <div className="right_bottom">
              {playlistObj && playlistObj.tracks.length > 0 ? (
                <TrackInfo
